...
function Banner({ item, index, active = false, tmdbLogo }) {
          ...
          <div className="max-w-[820px]">
            ...
            {tmdbLogo ? (
              <img
                ...
                fetchpriority={isPriority ? "high" : "low"}
                decoding="async"
                className="spotlight-logo mt-5 object-contain object-left h-[150px] max-w-[640px] w-auto drop-shadow-[0_6px_24px_rgba(0,0,0,0.7)] max-[1400px]:h-[120px] max-[1200px]:h-[100px] max-md:h-[72px] max-md:max-w-[80%]"
              />
            ) : (
