  ...
  return (
    <div className="max-w-5xl mx-auto pt-16 pb-5">
      ...
      <div className="space-y-12 text-white/60">
        ...
        {/* Highlighted account / data-risk disclaimer (shown to users when they
            tick "I agree" on the login / register popup). */}
        <div className="rounded-2xl border border-[#a855f7]/30 bg-[#a855f7]/10 p-6">
          <h2 className="text-xl font-semibold text-white mb-4">
            Accounts, Data &amp; Login Risk
          </h2>
          <p className="leading-relaxed text-base text-white/80 mb-4">
            Creating an account is completely optional. It exists only to sync
            your watch list, watch-later list and viewing progress across your
            devices. When you register, your email and a securely hashed version
            of your password are stored by our authentication provider
            (Supabase). We never store your password in plain text, and we never
            sell or share your data.
          </p>
          <p className="leading-relaxed text-base text-white/80 mb-4 font-medium">
            However, no online service can be guaranteed to be 100% secure.
            <span className="text-white">
              {" "}
              We are NOT responsible if any data leak or anything bad happens to
              your account or personal information. You log in and use any
              account features entirely at your own risk.
            </span>
          </p>
          <ul className="list-disc pl-6 space-y-2 text-base text-white/70">
            <li>Use a unique password you don't use on other important sites.</li>
            <li>
              Do not store any sensitive or personal information in your account
              — it is only meant for syncing what anime you watch.
            </li>
            <li>
              By ticking &ldquo;I agree to the Terms of Service&rdquo; on the
              login/register form, you accept this risk and these terms.
            </li>
          </ul>
        </div>
