  ...
  return (
    <div className="group relative transition-transform duration-500 ease-out hover:-translate-y-1.5">
      <Link
        to={infoPath}
        draggable={false}
        className="block relative w-full pb-[140%] rounded-xl overflow-hidden bg-[#1a1a22] ring-1 ring-white/[0.04] shadow-lg transition-all duration-500 ease-out group-hover:ring-[#a855f7]/40 group-hover:shadow-[0_18px_45px_rgba(168,85,247,0.22)]"
      >
        {poster ? (
          <img
            src={poster}
        ...
        <div className="absolute inset-0 bg-[#a855f7]/0 group-hover:bg-[#a855f7]/[0.07] transition-colors duration-500" />

        {/* hover "more info" overlay */}
        <div className="absolute inset-0 flex items-center justify-center">
          <span className="w-12 h-12 rounded-full bg-white/15 backdrop-blur-xl border border-white/25 flex items-center justify-center text-white text-lg scale-75 opacity-0 transition-all duration-[450ms] ease-out group-hover:opacity-100 group-hover:scale-100 group-hover:bg-[#a855f7] group-hover:border-[#a855f7] shadow-2xl">
      ...
      <div className="mt-2">
        <Link
          to={infoPath}
          className="block text-[13px] font-medium text-white line-clamp-1 transition-colors duration-300 group-hover:text-[#c084fc]"
          title={title}
        >
          {title}
        </Link>
