...
const client = axios.create({
  ...
  //
  // Lowered 12s -> 6s: if a mobile ISP blocks the primary TMDB host, we now fail
  // over to the mirror in 6s instead of 12s. Combined with the progressive render
  // in MoviesHome this is the difference between a 35-50s and a ~3s mobile load.
  timeout: 6000,
});
